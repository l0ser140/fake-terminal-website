...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Hello!\nMy name is Andrey and I'm YOBA DEVOPS SRE STACKOVERFLOW SENIOR ENGEENER.\nYou can use commands or side menu. Type 'help' to get a list of commands.",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "My name is Andrey\nI have been working in IT for more than 10 years and I'm YOBA DEVOPS SRE STACKOVERFLOW SENIOR ENGEENER.\nNow I work in a yellow bank where Oleg Tinkov not works anymore.\nMy skills:\n * troll 80lvl\n * ...",
        "mail.txt": "andrey@kochetkov.id",
        "linkedin.txt": "https://www.linkedin.com/in/a-kochetkov/",
        "telegram": "https://t.me/l0ser140",
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
    ...
    TypeSimulator.prototype.type = function (text, callback) {
        ...
        (function typer() {
            if (i < text.length) {
                ...
                i++;
                if (!skipped) {
                    setTimeout(typer, isNewLine ? timer * 200 : timer);
                } else {
